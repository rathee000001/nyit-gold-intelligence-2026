...
function TradingChart() {
  return (
    ...
    >
      ...
      <rect width="760" height="390" rx="34" fill="white" opacity="0.95" />
      ...
      {[
        { x: 132, y: 245, up: false },
        { x: 222, y: 207, up: true },
        { x: 315, y: 215, up: false },
        { x: 425, y: 146, up: true },
        { x: 540, y: 102, up: true },
        { x: 648, y: 82, up: true },
      ].map((candle, index) => (
...
function HeroVisual() {
  return (
    <div className="relative mx-auto h-[420px] w-full max-w-[720px] lg:h-[500px] lg:max-w-none">
      <div className="absolute right-0 top-0 z-20 rounded-[1.8rem] border border-slate-200 bg-slate-950 px-6 py-4 text-white shadow-2xl">
      ...
      <div className="absolute right-0 top-20 w-full overflow-hidden rounded-[2.4rem] border border-slate-100 bg-white/90 p-5 shadow-[0_30px_100px_rgba(15,23,42,0.14)] backdrop-blur-xl lg:p-7">
      ...
      <div className="absolute bottom-0 right-8 z-20 grid w-[min(520px,calc(100%-32px))] grid-cols-3 gap-3">
        <div className="rounded-2xl border border-blue-100 bg-white/95 p-4 shadow-xl backdrop-blur">
        ...
        <div className="rounded-2xl border border-yellow-100 bg-white/95 p-4 shadow-xl backdrop-blur">
          <p className="text-[9px] font-black uppercase tracking-[0.2em] text-slate-400">
            Models
          </p>
          <p className="mt-2 text-sm font-black text-slate-950">
        ...
        <div className="rounded-2xl border border-emerald-100 bg-white/95 p-4 shadow-xl backdrop-blur">
          <p className="text-[9px] font-black uppercase tracking-[0.2em] text-slate-400">
            AI
          </p>
          <p className="mt-2 text-sm font-black text-slate-950">
    ...
    <main className="min-h-screen overflow-hidden bg-white text-slate-950">
      ...
      <div className="hidden h-0 select-none overflow-hidden opacity-0">
        {`
          ...
          Top-right hero animation.
          Large gold coin removed.
...
print("Recreated src/app/page.tsx with clean top-right animation, no large gold coin, better project info, and responsive layout.")