...
COMPONENT = Path("src/components/interpreter/FloatingGoldInterpreter.tsx")
...
if 'FloatingGoldInterpreter' not in layout:
    # Add import after Footer import if possible, otherwise after globals import.
    if 'import Footer from "@/components/Footer";' in layout:
        layout = layout.replace(
            'import Footer from "@/components/Footer";',
            'import Footer from "@/components/Footer";\nimport FloatingGoldInterpreter from "@/components/interpreter/FloatingGoldInterpreter";',
            1,
        )
    elif 'import "./globals.css";' in layout:
        layout = layout.replace(
            'import "./globals.css";',
            'import "./globals.css";\nimport FloatingGoldInterpreter from "@/components/interpreter/FloatingGoldInterpreter";',
            1,
...
print("Created FloatingGoldInterpreter.tsx")
print("Patched layout.tsx to mount floating AI globally")